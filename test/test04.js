...
describe('ЗАДАЧА 4: функция isPalindrome', function(){
	...
	it('дает ложь для одного непалиндрома с несколькими подряд идущими пробелами', function(){
		assert.strictEqual(isPalindrome("M A  D A MADA"), false, "неверно для 'M A  D A MADA'");
	});
