...
describe('ЗАДАЧА 2: функция ph2f', function(){
	...
	it('дает верный ответ для строки с 5 вхождениями ph', function(){
           assert.strictEqual(ph2f("phphotographpherph"), "ffotografferf", "неверно для 'phphotographpherph'");
        });
	...
	it('дает верный ответ для строки без пиханий ph', function(){
           assert.strictEqual(ph2f("fysics is fun"), "fysics is fun", "неверно для 'fysics is fun'");
        });
});