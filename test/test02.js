...
describe('ЗАДАЧА 2: функция ph2f', function(){
    ...
    it('дает верный ответ строки без ph', function(){
           const ph2f = require('../L05-02.js');
           assert(ph2f("ererer"), "ererer", "неверно для 'ererer'");
    });
    
    it('дает верный ответ из строки состоящего из ph', function(){
           const ph2f = require('../L05-02.js');
           assert(ph2f("phph"), "ff", "неверно для 'phph'");
    });
